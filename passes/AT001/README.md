...
Namespaced under the check ID on the command line, as `-AT001.ignored-filename-prefixes=VALUE`.

| Flag | Default | Effect |
|---|---|---|
| `ignored-filename-prefixes` | `data_source_` | Comma-separated list of file name prefixes to ignore |
| `ignored-filename-suffixes` | _none_ | Comma-separated list of file name suffixes to ignore |

More information: <https://www.terraform.io/docs/extend/testing/acceptance-tests/testcase.html#checkdestroy>
...
Singular reports can be ignored by adding a `//lintignore:AT001` Go code comment at the end of the offending line or on the line immediately preceding, e.g.
