...
90 active checks in four categories. The full list, with a page per check, is in the [check index](docs/reference/checks.md) — or browse them at <https://jfrappier.github.io/tfsprout/reference/checks/>.
...
| [`S`](docs/reference/checks.md#schema-checks) | Schemas — `Schema` definitions and attribute maps | 42 |
