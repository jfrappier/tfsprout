...
<p class="hero-sub">86 checks over a provider's Go source, reporting the patterns that cause bugs, fail schema validation at runtime, or drift from Terraform Plugin SDK conventions.</p>
...
### [Schemas](reference/checks.md#schema-checks) <span class="card-count">38</span>
...
<div class="card" markdown="1">
### Reference
- [Check index](reference/checks.md) — all 95 IDs, each with its own page
